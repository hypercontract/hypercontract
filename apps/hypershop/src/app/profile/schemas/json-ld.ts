...
export const jsonLdSchemas: Schema[] = [
    ...
    objectWith('ApiRoot', ['@context'], ['orderHistory', 'searchCatalog', 'shoppingCart', 'userProfile']),
    ...
    objectWith('OrderHistory', ['@context', 'orders']),
    ...
    objectWith('SearchResults', ['@context', 'products', 'totalResults']),
    ...
    objectWith('UserProfile', ['@context', 'addresses', 'paymentOptions']),
